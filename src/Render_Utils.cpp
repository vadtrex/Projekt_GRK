...
void Core::SetActiveTexture(GLuint textureID, const std::string& uniformName, GLuint shaderProgram, GLuint textureUnit)
{
    ...
    glUniform1i(uniformLocation, textureUnit);       // Tell shader which texture unit to use
}
